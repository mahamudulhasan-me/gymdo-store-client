  ...
  return (
    <section className="border-t border-gray-300">
      <div className="container mx-auto grid grid-cols-12  py-4 ">
        <div className="md:col-span-3 col-span-6 flex items-end gap-4 border-r border-gray-300 py-2">
        ...
        <p className="md:col-span-4 col-span-6 text-gray-700 flex justify-center items-center text-right">
